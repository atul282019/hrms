		...
		if(token!=null) {
			...
			if(obj!=null) {
				if(obj.getUser_role()==9 || obj.getUser_role()==1 || obj.getUser_role()==2
						|| obj.getUser_role()==3  || obj.getUser_role()==12  || obj.getUser_role()==7) {
...
//}
	...
	public ModelAndView ProfileInfo(Model model) {
		...
		if(token!=null) {
			...
			if(obj!=null) {
				if(obj.getUser_role()==9 || obj.getUser_role()==1 || obj.getUser_role()==2 
						|| obj.getUser_role()==3 || obj.getUser_role()==10 || obj.getUser_role()==12 || obj.getUser_role()==7) {
				model.addAttribute("name",obj.getName());
				model.addAttribute("org",obj.getOrgName());
				model.addAttribute("mobile",obj.getMobile());
				model.addAttribute("email",obj.getEmail());
...
//	
	...
	return new ModelAndView("home", "command", "");
		...
		public ModelAndView settingOrganizationAccount(Model model) {
			...
			if(token!=null) {
				UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
				if(obj!=null) {
					if(obj.getUser_role()==9 || obj.getUser_role()==1 || obj.getUser_role()==2 || obj.getUser_role()==3) {
					model.addAttribute("name",obj.getName());
					model.addAttribute("org",obj.getOrgName());
					model.addAttribute("mobile",obj.getMobile());
					model.addAttribute("email",obj.getEmail());
		...
		public ModelAndView requestedVoucherList(Model model) {
			...
			if(token!=null) {
				UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
				if(obj!=null) {
					if(obj.getUser_role()==2 || obj.getUser_role()==9) {
					model.addAttribute("name",obj.getName());
					model.addAttribute("org",obj.getOrgName());
					model.addAttribute("mobile",obj.getMobile());
					model.addAttribute("email",obj.getEmail());
	...
	public ModelAndView bulkempUpload(Model model) {
		...
		if(token!=null) {
			...
			//	return new ModelAndView("bulk-vehicleupload", "command", "");
				return new ModelAndView("bulk-empUpload_new", "command", "");
			}
			 return new ModelAndView("error", "command", "");
		}
		return new ModelAndView("home", "command", "");
	...
	public ModelAndView customSupport(Model model) {
		...
		if(token!=null) {
			...
			if(obj!=null) {
				...
				return new ModelAndView("customSupport", "command", "");
			}
			 return new ModelAndView("error", "command", "");
		}
		return new ModelAndView("home", "command", "");
...
public ModelAndView crmtab1(Model model) {
	String token = (String) session.getAttribute("hrms");
	Integer id  = (Integer) session.getAttribute("id");
	if(token!=null) {
		UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
		if(obj!=null) {
			...
			return new ModelAndView("crmtab1", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
...
public ModelAndView brandDashboard(Model model) {
	...
	if(token!=null) {
		...
		if(obj!=null) {
			...
			model.addAttribute("email",obj.getEmail());
			model.addAttribute("employerId",id);
			return new ModelAndView("brand-dashboard", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
...
@GetMapping(value="/EmailerBankAC")
public ModelAndView EmailerBankAC(Model model) {
	String token = (String) session.getAttribute("hrms");
	Integer id  = (Integer) session.getAttribute("id");
	if(token!=null) {
		UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
		if(obj!=null) {
			...
			model.addAttribute("email",obj.getEmail());
			model.addAttribute("employerId",id);
			return new ModelAndView("Emailer_BankAC", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
...
@GetMapping(value="/TransactionEmailer")
public ModelAndView TransactionEmailer(Model model) {
	String token = (String) session.getAttribute("hrms");
	Integer id  = (Integer) session.getAttribute("id");
	if(token!=null) {
		UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
		if(obj!=null) {
			...
			model.addAttribute("email",obj.getEmail());
			model.addAttribute("employerId",id);
			return new ModelAndView("TransactionEmailer", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
...
@GetMapping(value="/RevokeVoucherEmailer")
public ModelAndView RevokeVoucherEmailer(Model model) {
	String token = (String) session.getAttribute("hrms");
	Integer id  = (Integer) session.getAttribute("id");
	if(token!=null) {
		UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
		if(obj!=null) {
			...
			model.addAttribute("email",obj.getEmail());
			model.addAttribute("employerId",id);
			return new ModelAndView("RevokeVoucherEmailer", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
...
@GetMapping(value="/IssueVoucherEmailer")
public ModelAndView IssueVoucherEmailer(Model model) {
	String token = (String) session.getAttribute("hrms");
	Integer id  = (Integer) session.getAttribute("id");
	if(token!=null) {
		UserDetailsEntity obj = JwtTokenValidator.parseToken(token);
		if(obj!=null) {
			...
			model.addAttribute("email",obj.getEmail());
			model.addAttribute("employerId",id);
			return new ModelAndView("IssueVoucherEmailer", "command", "");
		}
		 return new ModelAndView("error", "command", "");
	}
	return new ModelAndView("home", "command", "");
