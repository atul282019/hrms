...
public interface CommonUtils {
	...
	public static String resendOtpNew = "/userServices/Api/getOtpResend";//otp less
	...
	//public static String createSingleVoucherOLD = "/empService/Api/add/erupiVoucherInitiateDetailsNew";   //old 
	public static String createSingleVoucher = "/empService/Api/add/erupiVoucherSingleCreation";
	public static String erupiVoucherInitiateDetailsRequest = "/empService/Api/add/erupiVoucherInitiateDetailsRequest";
